<footer class="w-full border-t bg-white text-gray-800 pb-12">
  ...
  <h2 class="text-lg font-semibold mb-4 md:mb-0 md:self-start md:mr-8">Subscribe to our newsletter</h2>
  ...
  <div class="text-sm  m-36 md:text-base  md:mt-0 md:self-end">
    ...
    <div class="text-center md:border-l md:border-r md:border-t-0 md:px-8 md:py-12">
      <h2 class="text-lg font-semibold mb-4 text-left md:text-center">About Us</h2>
      <div class="text-sm">
    ...
    <div class="w-full container mx-auto flex flex-col items-center">
            <div class="flex flex-col md:flex-row text-center md:text-left md:justify-between py-6">
                <a href="#" class="uppercase hover:text-pink-600 px-3">About Us</a>
                <a href="#" class="uppercase hover:text-pink-600 px-3">Privacy Policy</a>
                <a href="#" class="uppercase hover:text-pink-600 px-3">Terms & Conditions</a>
                <a id="authentication-link" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="uppercase hover:text-pink-600 px-3">Contact US</a>
